...
drawTree(canvas.width/2, canvas.height - 80, 120, 0, 20, 'blue', 'pink');
...
function generateRandomTree(){
    ...
    let centerPintX = canvas.width/2;
    ...
    drawTree(centerPintX, canvas.height - 80, len, angle, branchWidth, color1, color2);
}
